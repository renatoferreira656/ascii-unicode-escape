AtomPlugin = require '../lib/atom-plugin'
  ...
  describe "when the atom-plugin:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atomPluginElement = workspaceElement.querySelector('.atom-plugin')
        expect(atomPluginElement).toExist()

        atomPluginPanel = atom.workspace.panelForItem(atomPluginElement)
